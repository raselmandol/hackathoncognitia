        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateHome', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <br>
                    <fieldset class="custom-fieldset-padding-border-radius">
                        <legend class="custom-legend-width-auto"><i class="fas fa-smile-beam"></i> @lang('For Better Well-Being')</legend>
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('We care about your health description') <b class="ambitious-crimson">*</b></label>
                                    <div class="col-md-12">
                    ...
                    <br>
                    <fieldset class="custom-fieldset-padding-border-radius">
                        <legend class="custom-legend-width-auto"><i class="fas fa-tooth"></i> @lang('Health Services')</legend>
                        <div class="row">
