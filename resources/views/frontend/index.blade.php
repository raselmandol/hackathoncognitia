...
<head>
	...
	<title>{{ $ApplicationSetting->item_name }} | @lang('Home') :: fedr.in</title>
	<!-- Font Awesome Icons -->
			...
			<div class="history-info position-relative">
				...
				<div class="position-relative">
					...
					<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
						<iframe src="https://www.youtube-nocookie.com/embed/3EV6ryG2j7E?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row story-6-grids text-left">
					...
					<div class="col-lg-7 story-gd pl-lg-4">
						<div class="title-content text-left mb-lg-5 mt-4">
							<h6 class="sub-title">@lang('For Better Well-Being')</h6>
			...
			<div class="container py-lg-5">
				...
				<div class="content-photo-grids row">
					...
					<div class="photo-6-inf-right col-lg-6 text-left pr-lg-5 mb-lg-0 mb-4">
						<h6 class="sub-title">@lang('We care about your health')</h6>
